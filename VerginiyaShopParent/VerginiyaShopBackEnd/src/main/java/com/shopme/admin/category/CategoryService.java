...
public class CategoryService {
    ...
    public String checkUnique(Integer id, String name, String alies) {
        ...
        if (isCreatingNew) {
            if (categoryByName != null) {
                ...
                Category categoryByAlias = repo.findByName(alies);
            ...
            Category categoryByAlias = repo.findByAlias(alies);
